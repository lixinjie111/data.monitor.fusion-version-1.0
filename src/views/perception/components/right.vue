...
<script>
    ...
    export default {
        data() {
            return {
                iframeUrl: window.config.iframeUrl+'cesium-map/modules/fusionMonitor/'+this.$route.name+'.html?crossId='+this.$route.params.crossId+'&delayTime='+this.$route.params.delayTime+'&extend='+this.$route.params.extend+'&lng='+this.$route.query.lng+'&lat='+this.$route.query.lat+'&isShowMapElement='+this.$route.query.isShowMapElement,
                // iframeUrl: 'http://127.0.0.1:8080/modules/fusionMonitor/'+this.$route.name+'.html?crossId='+this.$route.params.crossId+'&delayTime='+this.$route.params.delayTime+'&extend='+this.$route.params.extend+'&lng='+this.$route.query.lng+'&lat='+this.$route.query.lat+'&isShowMapElement='+this.$route.query.isShowMapElement,
                center:[],
                currentExtent:[],
                perExtent:[],
                x:0,
