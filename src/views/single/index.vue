...
<script>
    ...
    export default {
        data() {
            return {
                // +"&v="+new Date().getTime()
//               iframeUrl: window.config.staticUrl+'cesium-map/modules/fusionMonitor/'+this.$route.name+'.html?vehicleId='+this.$route.params.vehicleId+'&delayTime='+this.$route.query.delayTime+'&isShowMapElement='+this.$route.query.isShowMapElement,
