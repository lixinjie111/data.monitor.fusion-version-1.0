...
//     112.94760914128275, 28.325093927226323,
//     112.94860914128275, 28.326093927226323,
//     112.94960914128275, 28.327093927226323,
//     112.95060914128275, 28.328093927226323
//   ])
// });
...
// this.cesium.viewer.zoomTo(dataSourcePromise);
...
//   this.cesium.viewer.dataSources.add(Cesium.GeoJsonDataSource.load('static/data/4.geojson', {
//     fill:new Cesium.Color(0.5372549019607843,0.2941176470588235, 0.1686274509803922, 0.996),// Cesium.Color.fromCssColorString('#71446b'),//Cesium.Color.ALICEBLUE,
//     stroke: Cesium.Color.fromCssColorString('#71446b'),// Cesium.Color.ORANGE,
//     strokeWidth: 0,
//     markerSymbol: '?'
// }));
        ...
        this.cesium.viewer.camera.flyTo({
            destination: Cesium.Cartesian3.fromDegrees(this.minWGS84[0], this.minWGS84[1],this.defualtZ+ 39.142101722743725),
            orientation: hpr
        });

        // let hierarchy=[
        //   112.953651652808276, 28.329121301607586,50,
        //   112.953927670284884, 28.328597820186189,50,
        //   112.949996800703161, 28.326123180740126,50,
        //   112.949644640474389, 28.326513412345037,50,
        //   112.953651652808276, 28.329121301607586,50
        //  ];
        let hierarchy=[
