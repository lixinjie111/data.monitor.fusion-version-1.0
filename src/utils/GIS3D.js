class GIS3D {
    ...
    //   this.cesium.viewer.imageryLayers.remove(this.cesium.viewer.imageryLayers.get(0));
    debugger 
...
clampToGround: true //开启贴
    ...
    //     markerSymbol: '?'
    //   }));
      let a=this.cesium.viewer.dataSources.add(Cesium.GeoJsonDataSource.load('static/data/changsha/2.geojson', {
    ...
    //   }));
      ...
      a.then(function(dataSource)
      {
        ...
        entity._polyline.zIndex._value=10;
      ...
      //entity._polyline.distanceDisplayCondition= new Cesium.DistanceDisplayCondition(0, 60000.0);
